...
<div class="div-main" >
<div class="div-nav">
    <li><a href="/Interfaces/ManagingDirector/MdDashBoard.php">Dashboard</a></li>
    <li><a href="/Interfaces/ManagingDirector/MdAttendence.php">Attendance</a></li>
    <li><a href="/Interfaces/ManagingDirector/ApproveLeave.php">Approve Leave</a></li>
    <li class="dropdown-btn">
        <a href="#">Reports</a>
        <i class="fa fa-caret-right"></i>
    </li>
    <div class="dropdown-container">
        <li><a href="/Interfaces/ManagingDirector/AttendenceReport.php">Attendance Report</a></li>
        <li><a href="/Interfaces/ManagingDirector/LeaveReport.php">Leave Report</a></li>
   ...
   <!--  <li><a href="#">Approve Leave</a></li>
    ...
    <li><a href="/Interfaces/ManagingDirector/Salary.php">Salary</a></li>
    <li><a href="/Interfaces/ManagingDirector/MdProfile.php">Profile</a></li> 
</div>